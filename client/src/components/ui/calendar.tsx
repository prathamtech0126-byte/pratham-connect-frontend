  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          buttonVariants({ variant: "ghost" }),
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 rounded-full hover:bg-gray-100",
        ),
        ...
        day_selected:
          "bg-blue-500 text-white hover:bg-blue-600 hover:text-white focus:bg-blue-500 focus:text-white rounded-full shadow-sm",
        ...
        dropdown:
          "p-1 bg-transparent hover:bg-accent rounded-sm text-sm font-medium cursor-pointer border-none outline-none focus:ring-1 focus:ring-ring",
