...
// { icon: Target, label: "Lead list", href: "/leads", roles: ["superadmin", "manager", "counsellor", "telecaller"] },
 // { icon: LayoutGrid, label: "Kanban", href: "/leads/kanban", roles: ["superadmin", "manager", "counsellor", "telecaller"] },
  ...
  { icon: PieChart, label: "Reports", href: "/reports" },
  {
    ...
    roles: ["backend_manager", "application_team", "customer_experience", "binding_team", "superadmin"],
  },
  {
    icon: Settings,
    label: "Checklist Category",
    href: "/backend/checklist-categories",
    roles: ["superadmin", "backend_manager"],
  },
  {
    icon: FolderOpen,
    label: "Client Folder",
    href: "/backend/client-folders",
    roles: ["superadmin", "backend_manager", "application_team", "binding_team", "customer_experience"],
  },
  {
    icon: Users,
    label: "Team",
