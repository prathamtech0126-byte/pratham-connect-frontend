...
// // In App.tsx, update the AdminRoute component to also allow managers:
...
//    // In App.tsx, update the route for add-checklist to use ProtectedRoute instead of AdminRoute:
...
// {/* Add Checklist - Now accessible to all authenticated users */}
// <Route path="/add-checklist">
//   {params => <ProtectedRoute component={AddChecklistPage} />}
// </Route>
  ...
  return (
    <Suspense fallback={<PageLoadFallback />}>
      <Switch>
        ...
        {/* Add Checklist - Accessible to all authenticated users */}
       <Route path="/add-checklist">
  {params => <ProtectedRoute component={AddChecklistPage} />}
</Route>
